...
var DEFAULT_URL = '14306_231372691_7678977174_647.86.pdf';
...
var PDFViewerApplication = {
  ...
  zoomIn: function pdfViewZoomIn(ticks) {
    ...
    // Custom code for highliting while zoom
    var $annotationLayerDiv = $('.annotationLayer');
    if($annotationLayerDiv.length > 0){
    	var pageNumber = PDFViewerApplication.page;
        var pageView = this.pdfViewer.getPageView(pageNumber-1);
        var viewport = pageView.viewport;
        setupAnnotations(viewport,pageNumber);
    }
  },
